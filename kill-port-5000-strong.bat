@echo off
echo ========================================
echo   PORT 5000 ZORLA TEMIZLEME
echo ========================================
echo.
echo Port 5000'i kullanan TUM islemler kapatilacak...
echo.
echo Port 5000'i kullanan islemler:
...
if errorlevel 1 (
    echo.
    echo [BASARILI] Port 5000 serbest!
) else (
    echo.
    echo [UYARI] Port 5000 hala kullanimda olabilir.
